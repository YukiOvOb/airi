...
<template>
  <CursorFloating
    :class="[
      'before:mask-image-[linear-gradient(120deg,white_100%)] before:bg-linear-to-r hover:before:bg-linear-to-r',
      'relative min-h-120px flex flex-col cursor-pointer overflow-hidden rounded-xl',
      'bg-neutral-200/50 dark:bg-neutral-800/50',
      'drop-shadow-none transition-all duration-400 ease-in-out',
      'before:absolute before:inset-0 before:z-0 before:h-full before:w-25%',
      'before:from-primary-500/0 before:to-primary-500/0 before:opacity-0',
      'active:drop-shadow-[0px_0px_0px_rgba(220,220,220,0.25)]',
      'hover:drop-shadow-[0px_4px_4px_rgba(220,220,220,0.4)]',
      'before:transition-all before:duration-400 before:ease-in-out before:content-empty',
      'dark:before:from-primary-400/0',
      'hover:before:from-primary-500/20 hover:before:via-primary-500/10',
      'dark:before:to-primary-400/0 hover:before:to-transparent hover:before:opacity-100',
      'dark:hover:drop-shadow-none dark:hover:before:from-primary-400/20',
      'dark:hover:before:via-primary-400/10 dark:hover:before:to-transparent',
      isSelected
  ...
  >
    <div
      :class="[
        'after:bg-size-10px after:mask-image-[linear-gradient(165deg,white_30%,transparent_50%)]',
        'relative flex flex-1 flex-col justify-between gap-3 overflow-hidden rounded-lg',
        'bg-white p-5 text-primary-600/80 transition-all duration-400 ease-in-out',
        'after:absolute after:inset-0 after:z--2 after:h-full after:w-full',
        'dark:bg-neutral-900 dark:text-primary-300/80',
        'after:transition-all after:duration-400 after:ease-in-out after:content-empty',
        'after:bg-dotted-[neutral-200/80] dark:after:bg-dotted-[primary-200/20] hover:after:bg-dotted-[primary-300/50]',
      ]"
    >
