          ...
          <div class="flex flex-1 overflow-hidden">
            <div class="w-48 bg-neutral-50 p-2 dark:bg-neutral-900/50">
              <button
                ...
                :key="tab.id"
                :class="[
                  'mb-1 w-full flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium transition-colors',
                  activeTab === tab.id
