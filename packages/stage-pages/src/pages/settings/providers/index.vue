...
const providerBlocksConfig = [
  ...
  {
    id: 'embedding',
    icon: 'i-solar:diplomama-seal-bold-duotone',
    title: 'Embedding',
    description: 'Text embedding models for semantic memory search. e.g. OpenAI text-embedding-3-small',
    providersRef: allEmbedProvidersMetadata,
  },
]
